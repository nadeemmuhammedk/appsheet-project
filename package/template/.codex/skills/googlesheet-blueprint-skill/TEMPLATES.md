...
- Enable quick jumping to specific sheets, formula groups, or dependencies
...
2. [Sheet 1 Formulas](#sheet-1-formulas)
3. [Sheet 2 Formulas](#sheet-2-formulas)
4. [Common Formula Patterns](#common-formula-patterns)
5. [Formula Dependencies](#formula-dependencies)

---

**When generating documentation:**
- Include TOC after version header, before main content
- Link to all major sections (system overview, sheet formulas, common patterns, dependencies)
...
**Rules:**
- List each major sheet formula group or dependency as a bullet point
- Keep each item to one line — name + brief description
- Ordered roughly by importance (core formulas first, then lookups, then aggregations)
